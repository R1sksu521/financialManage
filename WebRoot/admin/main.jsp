...
// 		alert("uid:"+uid);
		var currentPage2=$("#currentPage3").val();//当前页		if (confirm('确认要删除该用户名')) {
			//判断当前用户是否可以进行删除
			$.ajax({
				type : "get",
						...
						<div>
							<ul class="nav navbar-nav navbar-right">
								<li><a href="javascript:void(0)">欢迎: <span class="glyphicon glyphicon-user"></span> ${sessionScope.admin.adminname }</a></li>
																<li><a href="${pageContext.request.contextPath}/shouzhiRecord/findShouzhiRecord.action"><span class="glyphicon glyphicon-home"></span> 返回前台</a></li>
										...
										<div class="form-group">
											<label id="sexLabel">性别&nbsp;&nbsp;   </label>
												...
												<span class="rightradio"> 
													<label class="radio-inline">
														<input type="radio" class="sexradio" name="sex" value="女">女													</label>
												</span>
										</div>
					            </div>
					            ...
					            <div class="modal-body"><!-- 在这里添加一些文本-->
										...
										<div class="form-group">
											<label id="sexLabel">性别&nbsp;&nbsp;   </label>
												...
												<span class="rightradio"> 
													<label class="radio-inline">
														<input id="nv_radio" type="radio" class="sexradio" name="sex" value="女">女													</label>
												</span>
										</div>
					            </div>
					            <div class="modal-footer">
