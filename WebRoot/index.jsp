	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-xs-10 col-xs-offset-1">
				<!-- 登录主体框 -->
				<div class="main-box">
					<img class="img-responsive" alt="财务管理系统" src="<%=basePath%>images/logo.jpg" id="logo">
					<hr />
					<h3>用户登录</h3>
					<form
						...
						<div class="form-group a">
							...
							<div class="form-group" style="text-align:center; margin-top:15px;">
								<a href="${pageContext.request.contextPath}/user/guestLogin.action"
									class="btn btn-default btn-block">游客访问</a>
