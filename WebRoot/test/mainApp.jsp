...
<!-- 手机响应式侧边栏的相关css文件 -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/app/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/app/css/default.css">
<link href="${pageContext.request.contextPath}/app/css/offcanvas.min.css" rel="stylesheet" type="text/css">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="home-navbar-collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="#" data-toggle="modal" data-target="#countMachine">计算器</a></li>
										...
										<div class="panel-body">
											...
											<div class="col-md-11 col-md-offset-1 col-xs-11 col-xs-offset-1 ">
													<div class="form-group">
														<label for="attYearMonth">收支年月</label>
														 <input type="text" class="form-control " id="attYearMonth"
															 name="szr_date" value="${date_condition}"  readonly>
													</div>
													<div class="form-group ">
								...
								<div class="row">
									<div class="col-md-12 ">
										...
										<form id="add_income_form"
											...
											<div>
												<label id="msgLabel" style="color:red;font-size:20px;">${msg }</label>
											</div>
											<div class="form-group">
		...
		<!-- 												style="color:red;font-size:20px;text-align:center;"></label> -->
											...
											<div class="row">
												...
												<input type="submit" id="add_income_submit"
													class="btn btn-success btn-lg" value="提交收入信息"> <span
								...
								<div class="row">
									<div class="col-md-12">
										...
										<form id="add_spend_form"
											...
											<div>
												<label id="msgSpendLabel" style="color:red;font-size:20px;">${msg }</label>
											</div>
